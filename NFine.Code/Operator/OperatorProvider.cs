...
namespace NFine.Code
{
    public class OperatorProvider
    {
        ...
        public static OperatorModel  _operatorModel ;
        public static string nfine_mac;
        public static string nfine_licence; 
        ...
        public OperatorModel GetCurrent()
        {
            ...
            if (operatorModel == null) { return _operatorModel; }
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            nfine_licence = Licence.GetLicence();
            nfine_mac = Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32);
